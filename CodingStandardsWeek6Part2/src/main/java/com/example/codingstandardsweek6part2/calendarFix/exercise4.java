package com.example.codingstandardsweek6part2.calendarFix;
...
public class exercise4 {
    ...
    System.out.println(cal2.after(cal1)); // T
    System.out.println(cal1.after(cal2)); // F
    System.out.println(cal1.after(cal1)); // T
    System.out.println(cal2.after(cal2)); // T
	}
}
